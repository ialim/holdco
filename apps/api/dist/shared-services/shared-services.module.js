...
const shared_services_controller_1 = require("./shared-services.controller");
...
exports.SharedServicesModule = SharedServicesModule = __decorate([
    (0, common_1.Module)({
        controllers: [shared_services_controller_1.SharedServicesController],
        providers: [shared_services_service_1.SharedServicesService],
    })
